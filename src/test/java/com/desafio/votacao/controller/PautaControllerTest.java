...
class PautaControllerTest {
    ...
    void criarPauta_ComSucesso() throws Exception {
        ...
        PautaResponse response = new PautaResponse(id, "Pauta Teste", "Descrição", StatusPauta.CRIADA, null, null,
                null);
    ...
    void abrirSessao_ComSucesso() throws Exception {
        UUID id = UUID.randomUUID();
        PautaResponse response = new PautaResponse(id, "Pauta Teste", "Descrição", StatusPauta.EM_VOTACAO, null, null,
                null);
    ...
    void votar_ComSucesso() throws Exception {
        ...
        VotoResponse response = new VotoResponse(UUID.randomUUID(), pautaId, associadoId, VotoEscolha.SIM, null);
    ...
    void fecharSessaoEObterResultado_ComSucesso() throws Exception {
        UUID pautaId = UUID.randomUUID();
        PautaResponse pautaEncerrada = new PautaResponse(pautaId, "Pauta Encerrada", "Descrição", StatusPauta.ENCERRADA,
                null, null, null);
        ResultadoResponse resultado = new ResultadoResponse(pautaId, "Pauta Encerrada", StatusPauta.ENCERRADA, 10L, 7L,
                3L);
